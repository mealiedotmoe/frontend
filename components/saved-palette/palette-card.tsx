...
export const PaletteCard: React.FunctionComponent<PaletteCardProps> = ({
  palette,
  onUse,
  onDelete,
  onColorPick,
  ...
  <section className="palette-card">
        ...
        .map((key: string) => (
          <>
            <div
              ...
              onClick={() =>
                onColorPick && onColorPick(palette[key].toString())
              }
              data-tip
    ...
    <section className="details">
      ...
      <button
        className="button text warn delete-btn"
